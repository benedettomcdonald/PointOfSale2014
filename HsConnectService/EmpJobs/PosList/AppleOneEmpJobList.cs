...
{
    public class AppleOneEmpJobList : EmpJobImpl
    {
        public AppleOneEmpJobList() { }
                ...
                while (text.Peek() > 0)
                {
                    ...
                    try
                    {
                            ...
                            for (int i = 0; i < 30; i++)
                            {
                                ...
                                if (Details.Preferences.PrefExists(Preference.APPLE_DOS_EMP_JOBS_TRAILING_ZERO)) //add pref here for extra 0's on the emp jobs
                                {
