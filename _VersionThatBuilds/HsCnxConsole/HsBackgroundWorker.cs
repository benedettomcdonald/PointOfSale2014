...
/**
 * HsBackgroundWorker - .NET 1.1 implementation of asynchronous forms invocation
 * 
 * Basically this is Delegate pattern in windows forms.
 * 
 * 
 * 
 * Original Algorithm courtesy of Juval Lowy
 * http://www.code-magazine.com/articleprint.aspx?quickid=0403071&printmode=true
 * 
 * 
 * Implementation adapted from the version on Roy Osherove's blog
 * http://osherove.com/blog/2004/6/16/backgroundworker-implementation-in-c.html
 * 
 * 
 * Changes from the above:
 * - code formatting and cleanup
 * - made DoWork result amorphic
 */
namespace HsCnxConsole
{

    #region HsBackgroundWorker
    public class HsBackgroundWorker
    {
